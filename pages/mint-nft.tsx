      ...
      <div className="flex justify-center">
        {walletAddress ? (
          <>
            ...
            <div className="w-1/2 flex flex-col pb-12">
              ...
              {fileUrl && (
                ...
                >
                  {!loading ? "Create NFT" : "Wait uploading image......"}
                </button>
              )}
            </div>
          </>
          ...
          <div className="flex flex-col mr-10 mt-10">
            <h1 className="m-5 text-xl">Please connect your  wallet</h1>
            <button
              onClick={connectMetamask}
              className="font-bold mt-4 bg-gray-300 text-white rounded p-4 shadow-lg"
            >
              Connect Metamask Wallet
            </button>
          </div>
